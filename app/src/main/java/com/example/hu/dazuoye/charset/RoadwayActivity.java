...
public class RoadwayActivity extends TitleActivity {
    private LinearLayout mRoadwayCurveLayout;

    private GraphicalView mRoadwayView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.roadway);
        setTitle("Roadway曲线图");
        showBackwardView(R.string.text_back,true);
        showEndView(true);
        mRoadwayCurveLayout = (LinearLayout) findViewById(R.id.chart_roadway);
        ...
        mRoadwayCurveLayout.addView(mRoadwayView, new ViewGroup.LayoutParams(
